...
namespace CoverFlowBase {
    public partial class UIFlow3D : LogicalPanel {
        ...
        public int TryViewportHitTest(Point position) {
        ...
        private void PrepareViewport() {
            _viewport =
                Application.LoadComponent(new Uri("/CoverFlowBase;component/Viewport.xaml", UriKind.Relative)) as
                Viewport3D;
        }
        ...
        public static readonly DependencyProperty LightProperty =
            DependencyProperty.Register("Light", typeof(Model3DGroup), typeof(UIFlow3D), new UIPropertyMetadata(null, OnLightChanged));
        ...
        private static void OnLightChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            Model3DGroup lightGroup = e.NewValue as Model3DGroup;
        ...
        public Model3DGroup Light {
            get { return (Model3DGroup)GetValue(LightProperty); }
        ...
        private void UpdateElementIndexes(UIElement affectedElement, bool attach) {
            INameScope scope = NameScope.GetNameScope(_viewport);
